 ...
 */
public class calcSpec2 extends AsyncTask<String, Integer, String> {
    ...
    public calcSpec2(int templateNbumber1, String file1) {
        super();
    ...
    protected String doInBackground(String... params) {
        ...
        time_array = new float[MainActivity.audioSamples[templateNumber].length];
